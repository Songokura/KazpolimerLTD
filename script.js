...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      'mq.5': 'мягкие соединения', 'mq.6': 'валы', 'mq.7': 'катки промышленные',
      ...
      'prod.g1': 'Сита полиуретановые', 'prod.g2': 'Катки промышленные', 'prod.g3': 'Колёса для спецтехники',
      ...
      'fut.s2': 'реже межремонтные интервалы — минимум',
      ...
      'ind.1': 'нефтегазодобыча', 'ind.2': 'горнодобыча', 'ind.3': 'металлургия', 'ind.4': 'химическая',
      'ind.5': 'строительная', 'ind.6': 'электротехническая', 'ind.7': 'пищевая', 'ind.8': 'сельское хозяйство',
      'ind.9': 'автомобильная', 'ind.10': 'медицинская', 'ind.11': 'текстильная', 'ind.12': 'полиграфия',
    ...
    kk: {
      ...
      'mq.5': 'жұмсақ қосылыстар', 'mq.6': 'біліктер', 'mq.7': 'өнеркәсіптік катоктар',
      ...
      'fut.s2': 'есе сирек — жөндеуаралық мерзімдер, кемінде',
      'fut.b1t': 'Жөндеу шығыны аз',
      'fut.b1x': 'Футерленбеген болат жабдықпен және резеңке футеровкамен салыстырғанда үнемді.',
      ...
      'fut.p3': 'Іші футерленген құбыр', 'fut.p4': 'Футеровка плиталары',
      ...
      'how.s1t': 'Өтінім',
      'how.s1x': 'Қоңырау шалыңыз немесе WhatsApp арқылы жазыңыз: міндетті сипаттап, сызбаны, эскизді немесе үлгінің фотосын қоса беріңіз.',
      'how.s2t': 'Пысықтау',
      ...
      'adv.a3t': 'Икемді төлем шарттары', 'adv.a3x': 'Шарттарды міндет пен көлемге қарай келісеміз.',
      ...
      'ct.kicker': 'Байланыс', 'ct.h2': 'Міндетіңізді талқылайық',
      ...
      'fm.phone': 'Телефон', 'fm.msg': 'Міндет',
      ...
      'wa.name': 'Есімі', 'wa.phone': 'Телефоны', 'wa.task': 'Міндеті'
    }
  };
